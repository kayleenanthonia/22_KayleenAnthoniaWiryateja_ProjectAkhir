...
//ambil daftar kamar
$querykamar = "select * from kamar where status='tersedia'";
$resultkamar = mysqli_query($koneksi,$querykamar);


//ambil data reservasi yg diubah
$id_reservasi = $_GET['id'];
$queryreservasi = mysqli_query($koneksi, "select * from reservasi where id_reservasi = '$id_reservasi'");
$data = mysqli_fetch_assoc($queryreservasi);
?>
